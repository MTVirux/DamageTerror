...
public class CombatantBarComponent
{
        ...
        Configuration config, MeterTab? activeTab) => col switch
    {
        ...
        BarColumn.MaxHit => ValueFormatter.AbbreviateSkillName(combatant.MaxHitSkillName, config.MaxHitSkillNameLength, config.TruncateSkillNames),
        ...
        BarColumn.MaxHeal => ValueFormatter.AbbreviateSkillName(combatant.MaxHealSkillName, config.MaxHitSkillNameLength, config.TruncateSkillNames),
    ...
    private (string Label, string Value) GetTooltipFieldValue(CombatantEntry combatant, TooltipField field, MeterTab? activeTab)
    {
        ...
        var value = field switch
        {
            ...
            TooltipField.MaxHit => ValueFormatter.AbbreviateSkillName(combatant.MaxHitSkillName, config.MaxHitSkillNameLength, config.TruncateSkillNames),
            TooltipField.MaxHitValue => GetColumnDisplayValue(combatant, BarColumn.MaxHitValue, config, activeTab),
            TooltipField.MaxHeal => ValueFormatter.AbbreviateSkillName(combatant.MaxHealSkillName, config.MaxHitSkillNameLength, config.TruncateSkillNames),
